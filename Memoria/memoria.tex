...
\begin{enumerate}[$\bullet$]
  \item \textbf{\textcolor{verde}{Bajar el volumen}}: para bajar el volumen, con el dedo estirado hacia la pantalla, podemos girarlo en el sentido antihorario. Girando el dedo en este sentido, reduciremos el volumen un 10\%, hasta un máximo del 5\% del volumen original.
  \item \textbf{\textcolor{verde}{Subir el volumen}}: este gesto es totalmente contrario al anterior. Se realiza en el sentido horario y subirá el volumen un 5\% hasta llegar al máximo.
\end{enumerate}
